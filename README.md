...
1. MySQL: Stored and organised all the data in a structured database with 5 linked tables

2. Microsoft Excel: Connected to the database and used as the data preparation layer

3. Power BI: Built the 4-page interactive dashboard with charts, KPI cards, and filters
